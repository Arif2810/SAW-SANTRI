<?php
	...
	$crMax = mysqli_query($koneksi, "SELECT 
		...
		FROM tbl_matrik WHERE status='1'");
	$max = mysqli_fetch_array($crMax);
	//Buat fungsi tampilkan nama
	function getNama($id){
		include("koneksi.php");
		$q =mysqli_query($koneksi, "SELECT * FROm tbl_santri where nik = '$id' AND status='1'");
	...
	function getKelas($id){
		include("koneksi.php");
		$k =mysqli_query($koneksi, "SELECT * FROm tbl_santri where nik = '$id' AND status='1'");
	...
	function getTh_ajaran($id){
		include("koneksi.php");
		$l =mysqli_query($koneksi, "SELECT * FROm tbl_santri where nik='$id' AND status='1'");
	...
	<div id="content" align="center">
		<div class="body">
			<div id="content" align="center">
				<div class="tengah">
				<br>
				<h1> ARSIP HASIL PERANGKINGAN PRESTASI SANTRI</h1>
				...
				<table class='display' cellspacing='0' width='100%'>
					...
					$sql3 = mysqli_query($koneksi, "SELECT * FROM tbl_matrik where status='1'");
